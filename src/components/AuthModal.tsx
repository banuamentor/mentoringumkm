...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  // Reset password visibility when auth mode changes
  useEffect(() => {
    setShowPassword(false);
    setShowConfirmPassword(false);
  }, [mode]);
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full rounded-lg border border-slate-300 py-2 pl-9 pr-10 text-sm text-slate-900 placeholder:text-slate-400 focus:border-indigo-600 focus:ring-1 focus:ring-indigo-600 outline-none"
                  />
                  <button
                    type="button"
